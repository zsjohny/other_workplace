...
@ComponentScan(basePackages = {
		"com.jiuy.operator,com.admin,com.supplier.service,com.jiuyuan.service.common,com.jiuy.rb" }, excludeFilters = {
...
public class RootSpringConfig {
	...
	public OssConfigVo ossConfig() {
		...
		ossConfig.setOssAccessKeyId(Client.OSS_ACCESS_KEY_ID);
		ossConfig.setOssAccessKeySecret(Client.OSS_ACCESS_KEY_SECRET);
		ossConfig.setOssBucket(Client.OSS_DEFAULT_BASEPATH_NAME);
		ossConfig.setOssUrl(Client.OSS_END_POINT);
		return ossConfig;
	}
