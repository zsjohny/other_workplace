package com.jiuy.operator.common.constant.factory;
...
import com.admin.core.support.StrKit;
...
import com.jiuy.operator.common.system.persistence.dao.DeptMapper;
...
import com.jiuy.operator.common.system.persistence.dao.NoticeMapper;
...
import com.jiuy.operator.common.system.persistence.model.Notice;
...
public class OperatorConstantFactory implements IOperatorConstantFactory {
    ...
    public static IOperatorConstantFactory me() {
		return SpringContextHolder.getBean("operatorConstantFactory");
    }
