package com.jiuy.operator.core.shiro.factory;
...
public class ShiroFactroy implements IShiro {
	...
	public ShiroUser shiroUser(User user) {
		...
		shiroUser.setDeptName(OperatorConstantFactory.me().getDeptName(user.getDeptid()));// 部门名称
		...
		for (int roleId : roleArray) {
			roleList.add(roleId);
			roleNameList.add(OperatorConstantFactory.me().getSingleRoleName(roleId));
		}
	...
	public String findRoleNameByRoleId(Integer roleId) {
		return OperatorConstantFactory.me().getSingleRoleTip(roleId);
	}
