 ...
 */
package com.jiuy.operator.core.shiro;
...
public class ShiroKit {
    ...
    public static List<Integer> getDeptDataScope() {
        ...
        List<Integer> subDeptIds = OperatorConstantFactory.me().getSubDeptId(deptId);
    ...
    public static boolean isAdmin() {
        ...
        for (Integer integer : roleList) {
            String singleRoleTip = OperatorConstantFactory.me().getSingleRoleTip(integer);
