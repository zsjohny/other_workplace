...
import com.jiuy.operator.common.system.warpper.NoticeWrapper;
...
public class NoticeController extends BaseController {
    ...
    @ResponseBody
    @BussinessLog(value = "新增通知",key = "title",dict = DictConst.NoticeMap)
    ...
    @ResponseBody
    @BussinessLog(value = "删除通知",key = "noticeId",dict = DictConst.DeleteDict)
    public Object delete(@RequestParam Integer noticeId) {

        //缓存通知名称
        LogObjectHolder.me().set(OperatorConstantFactory.me().getNoticeTitle(noticeId));
    ...
    @ResponseBody
    @BussinessLog(value = "修改通知",key = "title",dict = DictConst.NoticeMap)
