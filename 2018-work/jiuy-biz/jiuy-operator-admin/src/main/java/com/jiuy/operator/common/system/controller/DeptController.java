...
import com.jiuy.operator.common.system.dao.DeptDao;
...
import com.jiuy.operator.common.system.service.IDeptService;
import com.jiuy.operator.common.system.warpper.DeptWarpper;
...
public class DeptController extends BaseController {
    ...
    public String deptUpdate(@PathVariable Integer deptId, Model model) {
        ...
        model.addAttribute("pName", OperatorConstantFactory.me().getDeptName(dept.getPid()));
     ...
     * 新增部门
     */
    @BussinessLog(value = "添加部门", key = "simplename", dict = DictConst.DeptDict)
     ...
     * 修改部门
     */
    @BussinessLog(value = "修改部门", key = "simplename", dict = DictConst.DeptDict)
     ...
     * 删除部门
     */
    @BussinessLog(value = "删除部门", key = "deptId", dict = DictConst.DeleteDict)
    ...
    public Object delete(@RequestParam Integer deptId) {
        ...
        //缓存被删除的部门名称
        LogObjectHolder.me().set(OperatorConstantFactory.me().getDeptName(deptId));
