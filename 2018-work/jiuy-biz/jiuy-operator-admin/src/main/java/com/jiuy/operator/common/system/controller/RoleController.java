...
import com.jiuy.operator.common.system.dao.RoleDao;
import com.jiuy.operator.common.system.persistence.dao.RoleMapper;
import com.jiuy.operator.common.system.persistence.dao.UserMapper;
import com.jiuy.operator.common.system.persistence.model.Role;
import com.jiuy.operator.common.system.persistence.model.User;
import com.jiuy.operator.common.system.service.IRoleService;
import com.jiuy.operator.common.system.warpper.RoleWarpper;
...
public class RoleController extends BaseController {
    ...
    public String roleEdit(@PathVariable Integer roleId, Model model) {
        ...
        model.addAttribute("pName", OperatorConstantFactory.me().getSingleRoleName(role.getPid()));
        model.addAttribute("deptName", OperatorConstantFactory.me().getDeptName(role.getDeptid()));
    ...
    public String roleAssign(@PathVariable("roleId") Integer roleId, Model model) {
        ...
        model.addAttribute("roleName", OperatorConstantFactory.me().getSingleRoleName(roleId));
    ...
    @BussinessLog(value = "添加角色", key = "name", dict = DictConst.RoleDict)
    ...
    @BussinessLog(value = "修改角色", key = "name", dict = DictConst.RoleDict)
    @Permission(SysConst.ADMIN_NAME)
    @ResponseBody
    ...
    @BussinessLog(value = "删除角色", key = "roleId", dict = DictConst.DeleteDict)
    @Permission(SysConst.ADMIN_NAME)
    @ResponseBody
    public Tip remove(@RequestParam Integer roleId) {
        ...
        //不能删除超级管理员角色
        if(roleId.equals(SysConst.ADMIN_ROLE_ID)){
            throw new BussinessException(BizExceptionEnum.CANT_DELETE_ADMIN);
        }

        //缓存被删除的角色名称
        LogObjectHolder.me().set(OperatorConstantFactory.me().getSingleRoleName(roleId));
    ...
    @BussinessLog(value = "配置权限", key = "roleId,ids", dict = DictConst.RoleDict)
    @Permission(SysConst.ADMIN_NAME)
    @ResponseBody
