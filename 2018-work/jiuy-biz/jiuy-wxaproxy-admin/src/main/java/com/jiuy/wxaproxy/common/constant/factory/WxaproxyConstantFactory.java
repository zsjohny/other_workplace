package com.jiuy.wxaproxy.common.constant.factory;
...
import com.jiuy.wxaproxy.common.system.persistence.dao.DictMapper;
import com.jiuy.wxaproxy.common.system.persistence.dao.MenuMapper;
import com.jiuy.wxaproxy.common.system.persistence.dao.NoticeMapper;
...
public class WxaproxyConstantFactory implements IWxaproxyConstantFactory {
    ...
    public static IWxaproxyConstantFactory me() {
		return SpringContextHolder.getBean("wxaproxyConstantFactory");
    }
