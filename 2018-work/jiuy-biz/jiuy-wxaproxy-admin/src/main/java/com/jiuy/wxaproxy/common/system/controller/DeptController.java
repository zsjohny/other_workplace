...
import com.jiuy.wxaproxy.common.system.dao.DeptDao;
import com.jiuy.wxaproxy.common.system.persistence.dao.DeptMapper;
import com.jiuy.wxaproxy.common.system.persistence.model.Dept;
import com.jiuy.wxaproxy.common.system.service.IDeptService;
import com.jiuy.wxaproxy.common.system.warpper.DeptWarpper;
...
public class DeptController extends BaseController {
    ...
    public String deptUpdate(@PathVariable Integer deptId, Model model) {
        ...
        model.addAttribute("pName", WxaproxyConstantFactory.me().getDeptName(dept.getPid()));
    ...
    public Object delete(@RequestParam Integer deptId) {
        ...
        //缓存被删除的部门名称
        LogObjectHolder.me().set(WxaproxyConstantFactory.me().getDeptName(deptId));
