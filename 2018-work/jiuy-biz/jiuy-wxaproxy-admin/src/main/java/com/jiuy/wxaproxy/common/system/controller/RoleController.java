...
import com.jiuy.wxaproxy.common.system.warpper.RoleWarpper;
...
public class RoleController extends BaseController {
    ...
    public String roleEdit(@PathVariable Integer roleId, Model model) {
        ...
        model.addAttribute("pName", WxaproxyConstantFactory.me().getSingleRoleName(role.getPid()));
        model.addAttribute("deptName", WxaproxyConstantFactory.me().getDeptName(role.getDeptid()));
    ...
    public String roleAssign(@PathVariable("roleId") Integer roleId, Model model) {
        ...
        model.addAttribute("roleName", WxaproxyConstantFactory.me().getSingleRoleName(roleId));
    ...
    public Tip remove(@RequestParam Integer roleId) {
        ...
        //缓存被删除的角色名称
        LogObjectHolder.me().set(WxaproxyConstantFactory.me().getSingleRoleName(roleId));
