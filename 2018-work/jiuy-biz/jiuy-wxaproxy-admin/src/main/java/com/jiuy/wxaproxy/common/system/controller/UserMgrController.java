...
import com.jiuy.wxaproxy.common.system.dao.UserMgrDao;
import com.jiuy.wxaproxy.common.system.factory.UserFactory;
...
import com.jiuy.wxaproxy.common.system.transfer.UserDto;
import com.jiuy.wxaproxy.common.system.warpper.UserWarpper;
...
//	private final String DEFAULT_BASEPATH_NAME = "";//ThirdPartService.OSS_DEFAULT_BASEPATH_NAME;
	...
	public String userEdit(@PathVariable Integer userId, Model model) {
		...
		model.addAttribute("roleName", WxaproxyConstantFactory.me().getRoleName(user.getRoleid()));
		model.addAttribute("deptName", WxaproxyConstantFactory.me().getDeptName(user.getDeptid()));
