 ...
 */
package com.jiuy.wxaproxy.core.shiro;
...
public class ShiroKit {
    ...
    public static List<Integer> getDeptDataScope() {
        ...
        List<Integer> subDeptIds = WxaproxyConstantFactory.me().getSubDeptId(deptId);
    ...
    public static boolean isAdmin() {
        ...
        for (Integer integer : roleList) {
            String singleRoleTip = WxaproxyConstantFactory.me().getSingleRoleTip(integer);
            if (singleRoleTip.equals(SysConst.ADMIN_NAME)) {
                return true;
            }
        }
        return false;
