package com.yujj.layimjavaclient.dao;
...
import com.yujj.layimjavaclient.dao.db.SQLHelper;
import com.yujj.layimjavaclient.dao.operate.LayIMGetMemberIdsOperate;
import com.yujj.layimjavaclient.dao.operate.LayIMResultSetOperate;
...
public class LayIMDao {
    ...
    public boolean addMsgRecord(ToDBMessage message){
        ...
        System.out.println("添加聊天记录  addMsgRecord  sql:"+sql+",param:"+param);
