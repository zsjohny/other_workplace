...
public class ShopCoupon implements Serializable{
    ...
    public ShopCoupon(Long id, String code, String templateName, Integer type, Integer rangeType,
	...
	public String getValidityStartTimeStr() {
		...
		return UtilDate.getDateStrFromMillis(validityStartTime, UtilDate.yearMonthDay);
	...
	public String getValidityEndTimeStr() {
		...
		return UtilDate.getDateStrFromMillis(validityEndTime, UtilDate.yearMonthDay);
