 ...
 * 商品信息表
 * @author QiuYuefan
 * CREATE TABLE `shop_productlog` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `product_id` BIGINT(20) NOT NULL COMMENT '商品Id',
  `admin_id` BIGINT(20) NOT NULL COMMENT '操作员Id 1:超级管理员',
  `type` TINYINT(4) NOT NULL COMMENT '1:创建 2:删除 3:编辑 4：上下架 5：置顶',
 ...
 * @since 2017-10-10
 */
@TableName("shop_product_log")
public class ShopProductLog extends Model<ShopProductLog> {
    ...
    /**
     * 1:创建 2:删除 3:编辑 4：上下架 5：置顶、取消置顶
     */
