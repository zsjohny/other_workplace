...
public enum GlobalSettingName implements StringEnum {
	// 客户端底部导航栏配置
	...
	public static GlobalSettingName getByStringValue(String stringValue) {
		for (GlobalSettingName globalSettingName : GlobalSettingName.values()) {
			if (StringUtils.equals(globalSettingName.getStringValue(), stringValue)) {
