 ...
 * @project rest_demo
 */
package com.jiuyuan.entity.ucpaas.client;
...
import com.jiuyuan.entity.ucpaas.DateUtil;
import com.jiuyuan.entity.ucpaas.EncryptUtil;
import com.jiuyuan.entity.ucpaas.models.AppBill;
import com.jiuyuan.entity.ucpaas.models.Callback;
import com.jiuyuan.entity.ucpaas.models.ClientBill;
import com.jiuyuan.entity.ucpaas.models.TemplateSMS;
import com.jiuyuan.entity.ucpaas.models.VoiceCode;
public class JsonReqClient extends AbsRestClient {
	...
	public String createClient(String accountSid, String authToken, 
		...
		try {
			...
			String url = getStringBuffer().append("/").append(version).
					...
					.append("/Clients")
					.append("?sig=").append(signature).toString();
			UcpaasClient client=new UcpaasClient();
	...
	public String voiceCode(String accountSid, String authToken, String appId,
		...
		try {
			...
			voiceCode.setCaptchaCode(verifyCode);
			voiceCode.setTo(to);
			voiceCode.setPlayTimes("3");
			voiceCode.setDisplayNum("125909888870");
			Gson gson = new Gson();
