...
public class BizUtil{
    ...
    public static JsonResponse exceptionHandler(Throwable e) {
        ...
        if (e instanceof BizException) {
            ...
            return new JsonResponse ().setResultCode (ResultCode.COMMON_ERROR_BAD_PARAMETER).setError (be.getMsg ());
        }
        else {
    ...
    public static <T> T jsonStrToListObject(String json, Class<? extends T> clazz, Class<?> item) {
