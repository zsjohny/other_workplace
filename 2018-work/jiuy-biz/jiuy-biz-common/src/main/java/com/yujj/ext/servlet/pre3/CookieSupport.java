...
/**
 * Copied from tomcat source code.
 */
public final class CookieSupport {
    ...
    /**
     * If true, separators that are not explicitly dis-allowed by the v0 cookie spec but are disallowed by the HTTP spec
     * will be allowed in v0 cookie names and values. These characters are: \"()/:<=>?@[\\]{} Note that the inclusion of
    ...
    /**
     * The list of separators that apply to version 1 cookies. This may or may not include '/' depending on the setting
     * of {@link #FWD_SLASH_IS_SEPARATOR}.
     */
    ...
    static {
        ...
        ALLOW_NAME_ONLY =
            Boolean.valueOf(System.getProperty("org.apache.tomcat.util.http.ServerCookie.ALLOW_NAME_ONLY", "false")).booleanValue();
