...
public class CouponTemplate implements Serializable{
	...
	public CouponTemplate(Long id, String name, Integer type, Double money, Integer rangeType, String rangeContent,
...
//		周年庆5元通用代金券（ID:12）
		return name + money + "元" + RangeType.getByValue(rangeType).getDescription() + "代金券(ID:" + id + ")";
	}
