...
public class StoreMessageBoard extends BaseMeta<Long> implements Serializable {
	...
	public StoreMessageBoard(long serviceId2, long adminId2, String adminName2, String message2) {
