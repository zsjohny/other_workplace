package com.jiuy.supplier.common.constant.factory;
...
import com.jiuy.supplier.common.system.persistence.dao.DictMapper;
import com.jiuy.supplier.common.system.persistence.dao.MenuMapper;
import com.jiuy.supplier.common.system.persistence.dao.NoticeMapper;
...
public class SupplierConstantFactory implements ISupplierConstantFactory {
    ...
    public static ISupplierConstantFactory me() {
		return SpringContextHolder.getBean("supplierConstantFactory");
    }
