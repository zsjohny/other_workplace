...
import com.jiuy.supplier.common.system.dao.RoleDao;
import com.jiuy.supplier.common.system.persistence.dao.RoleMapper;
...
import com.jiuy.supplier.common.system.service.IRoleService;
import com.jiuy.supplier.common.system.warpper.RoleWarpper;
...
public class RoleController extends BaseController {
    ...
    public String roleEdit(@PathVariable Integer roleId, Model model) {
        ...
        model.addAttribute("pName", SupplierConstantFactory.me().getSingleRoleName(role.getPid()));
        model.addAttribute("deptName", SupplierConstantFactory.me().getDeptName(role.getDeptid()));
    ...
    public String roleAssign(@PathVariable("roleId") Integer roleId, Model model) {
        ...
        model.addAttribute("roleName", SupplierConstantFactory.me().getSingleRoleName(roleId));
    ...
    public Tip remove(@RequestParam Integer roleId) {
        ...
        //缓存被删除的角色名称
        LogObjectHolder.me().set(SupplierConstantFactory.me().getSingleRoleName(roleId));
