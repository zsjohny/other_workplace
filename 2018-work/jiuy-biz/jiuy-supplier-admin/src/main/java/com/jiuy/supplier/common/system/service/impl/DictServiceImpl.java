...
import static com.admin.common.constant.factory.MutiStrFactory.MUTI_STR_KEY;
import static com.admin.common.constant.factory.MutiStrFactory.MUTI_STR_VALUE;
import static com.admin.common.constant.factory.MutiStrFactory.parseKeyValue;
...
import com.jiuy.supplier.common.system.dao.DictDao;
import com.jiuy.supplier.common.system.service.IDictService;
...
public class DictServiceImpl implements IDictService {
	...
	public void addDict(String dictName, String dictValues) {
		...
		List<Dict> dicts = dictMapper
				.selectList(new EntityWrapper<Dict>().eq("name", dictName).and().eq("pid", 0));
