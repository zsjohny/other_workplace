...
import com.jiuy.supplier.common.system.dao.DeptDao;
...
import com.jiuy.supplier.common.system.warpper.DeptWarpper;
...
public class DeptController extends BaseController {
    ...
    public String deptUpdate(@PathVariable Integer deptId, Model model) {
        ...
        model.addAttribute("pName", SupplierConstantFactory.me().getDeptName(dept.getPid()));
    ...
    public Object delete(@RequestParam Integer deptId) {
        ...
        //缓存被删除的部门名称
        LogObjectHolder.me().set(SupplierConstantFactory.me().getDeptName(deptId));
