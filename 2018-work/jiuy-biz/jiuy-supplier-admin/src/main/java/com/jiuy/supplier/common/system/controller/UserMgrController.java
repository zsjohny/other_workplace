...
import com.jiuy.supplier.common.system.factory.UserFactory;
...
import com.jiuy.supplier.common.system.transfer.UserDto;
import com.jiuy.supplier.common.system.warpper.UserWarpper;
...
//	private final String DEFAULT_BASEPATH_NAME = "";//ThirdPartService.OSS_DEFAULT_BASEPATH_NAME;
	...
	public String userEdit(@PathVariable Integer userId, Model model) {
		...
		model.addAttribute("roleName", SupplierConstantFactory.me().getRoleName(user.getRoleid()));
		model.addAttribute("deptName", SupplierConstantFactory.me().getDeptName(user.getDeptid()));
