...
import com.jiuy.supplier.common.system.service.IMenuService;
import com.jiuy.supplier.common.system.warpper.MenuWarpper;
...
public class MenuController extends BaseController {
    ...
    public String menuEdit(@PathVariable Integer menuId, Model model) {
        ...
        menuMap.put("pcodeName", SupplierConstantFactory.me().getMenuNameByCode(temp.getCode()));
    ...
    public Tip add(@Valid Menu menu, BindingResult result) {
        ...
        //判断是否存在该编号
        String existedMenuName = SupplierConstantFactory.me().getMenuNameByCode(menu.getCode());
    ...
    public Tip remove(@RequestParam Integer menuId) {
        ...
        //缓存菜单的名称
        LogObjectHolder.me().set(SupplierConstantFactory.me().getMenuName(menuId));
