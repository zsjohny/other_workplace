...
import com.qianmi.open.api.response.D2pLogisticsCancelResponse;
 ...
 * @since 1.0
 */
public class D2pLogisticsCancelRequest implements QianmiRequest<D2pLogisticsCancelResponse> {
	...
	public Class<D2pLogisticsCancelResponse> getResponseClass() {
		return D2pLogisticsCancelResponse.class;
	}
