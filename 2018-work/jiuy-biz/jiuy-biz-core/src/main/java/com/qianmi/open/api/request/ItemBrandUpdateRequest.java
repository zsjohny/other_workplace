...
import com.qianmi.open.api.response.ItemBrandUpdateResponse;
 ...
 * @since 1.0
 */
public class ItemBrandUpdateRequest implements QianmiRequest<ItemBrandUpdateResponse> {
	...
	public Class<ItemBrandUpdateResponse> getResponseClass() {
		return ItemBrandUpdateResponse.class;
	}
