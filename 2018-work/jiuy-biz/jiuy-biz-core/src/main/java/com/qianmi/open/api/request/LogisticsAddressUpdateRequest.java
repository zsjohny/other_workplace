...
import com.qianmi.open.api.response.LogisticsAddressUpdateResponse;
 ...
 * @since 1.0
 */
public class LogisticsAddressUpdateRequest implements QianmiRequest<LogisticsAddressUpdateResponse> {
	...
	public Class<LogisticsAddressUpdateResponse> getResponseClass() {
		return LogisticsAddressUpdateResponse.class;
	}
