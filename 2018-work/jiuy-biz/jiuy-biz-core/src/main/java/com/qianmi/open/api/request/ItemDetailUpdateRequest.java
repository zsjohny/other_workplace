 ...
 * @since 1.0
 */
public class ItemDetailUpdateRequest implements QianmiRequest<ItemDetailUpdateResponse> {
	...
	public Class<ItemDetailUpdateResponse> getResponseClass() {
		return ItemDetailUpdateResponse.class;
	}
