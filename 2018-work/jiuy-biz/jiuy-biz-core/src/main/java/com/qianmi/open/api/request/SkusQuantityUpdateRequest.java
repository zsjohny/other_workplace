...
import com.qianmi.open.api.response.SkusQuantityUpdateResponse;
 ...
 * @since 1.0
 */
public class SkusQuantityUpdateRequest implements QianmiRequest<SkusQuantityUpdateResponse> {
