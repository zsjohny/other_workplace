...
import com.qianmi.open.api.response.MemberlevelAddResponse;
 ...
 * @since 1.0
 */
public class MemberlevelAddRequest implements QianmiRequest<MemberlevelAddResponse> {
	...
	public Class<MemberlevelAddResponse> getResponseClass() {
		return MemberlevelAddResponse.class;
	}
