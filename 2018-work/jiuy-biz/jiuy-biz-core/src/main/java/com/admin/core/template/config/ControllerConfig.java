...
public class ControllerConfig {
	...
	public void init() {
		...
		imports.add("com.admin.core.base.controller.BaseController");
		...
		this.packageName = "com.admin.modular." + contextConfig.getModuleName() + ".controller";
		this.controllerPathTemplate = "\\src\\main\\java\\com\\jiuy\\supplier\\modular\\"
