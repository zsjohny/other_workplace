...
public class ServiceConfig {
	...
	public void init() {
		...
		imports.add("com.admin.modular." + contextConfig.getModuleName() + ".service.I"
				+ contextConfig.getBizEnBigName() + "Service");
		this.serviceImplImports = imports;
		this.servicePathTemplate = "\\src\\main\\java\\com\\jiuy\\supplier\\modular\\" + contextConfig.getModuleName()
				+ "\\service\\I{}Service.java";
		this.serviceImplPathTemplate = "\\src\\main\\java\\com\\jiuy\\supplier\\modular\\"
				+ contextConfig.getModuleName() + "\\service\\impl\\{}ServiceImpl.java";
		this.packageName = "com.admin.modular." + contextConfig.getModuleName() + ".service";
	}
