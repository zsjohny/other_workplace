...
@Service
public class MyAccountGroundService {
	private static final Log logger = LogFactory.get("MyAccountGroundService"); 
	...
	public void updatePassword(String phoneNumber, String verifyCode, String sendType) {
		//检验验证码
