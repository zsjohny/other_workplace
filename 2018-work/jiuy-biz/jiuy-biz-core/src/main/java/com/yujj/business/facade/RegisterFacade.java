...
import com.yujj.business.service.common.SmsService;
...
public class RegisterFacade {
    ...
    public boolean sendPhoneInitPassword(String phone, String password) {
    	...
    	if (!SMS_SERVICE_FLAG) {
    		...
    		return smsService.send(phone, content, 1);
    	} else {
    		JSONArray params = new JSONArray();
    		params.add(coinNum + "");
    		params.add(password);
    		
    		return yunXinSmsService.send(phone, params, 8224); // Fix me
    	}
    ...
    public boolean sendPhoneVerifyCode(String phone, CodeUseage codeUseage) {
        ...
        */
    	...
    	boolean success = yunXinSmsService.sendCode(phone,1);
        return success;
    ...
    public boolean verifyPhoneVerifyCode(String phone, String verifyCode, boolean removeIfSuccess, CodeUseage codeUseage) {
      /*
    	...
    	if (whitePhoneService.getWhitePhone(phone) > 0) return true;
    	return yunXinSmsService.verifyCode(phone, verifyCode);
    }
