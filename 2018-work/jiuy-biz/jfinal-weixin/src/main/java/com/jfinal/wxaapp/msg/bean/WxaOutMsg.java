...
public abstract class WxaOutMsg implements Serializable {
    // 接收方帐号（收到的OpenID）
     ...
     * @param inMsg inMsg
     */
    public WxaOutMsg(WxaMsg wxaMsg) {
        this.toUserName = wxaMsg.getFromUserName();
        this.fromUserName = wxaMsg.getToUserName();
        this.createTime = now();
    }
     ...
     * @param inMsg inMsg
     */
    public WxaOutMsg(WxaOutMsg wxaOutMsg) {
        this.toUserName = wxaOutMsg.getFromUserName();
        this.fromUserName = wxaOutMsg.getToUserName();
        this.createTime = now();
    }
