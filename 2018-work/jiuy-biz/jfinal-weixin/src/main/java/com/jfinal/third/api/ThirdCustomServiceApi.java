 ...
 */
public class ThirdCustomServiceApi {
     ...
     * @return {ApiResult}
     */
    public static ApiResult getRecord(String jsonStr,String authorizer_appid) {
     ...
     * @return ApiResult
     */
    public static ApiResult getRecord(int pageindex, int pagesize, long starttime, long endtime,String authorizer_appid) {
        ...
        return getRecord(JsonUtils.toJson(params), authorizer_appid);
    }
     ...
     * @return ApiResult
     */
    public static ApiResult addKfAccount(String kf_account, String nickname, String password,String authorizer_appid) {
//        String accessToken = AccessTokenApi.getAccessTokenStr();
     ...
     * @return ApiResult
     */
    public static ApiResult updateKfAccount(String kf_account, String nickname, String password,String authorizer_appid) {
//        String accessToken = AccessTokenApi.getAccessTokenStr();
    	String accessToken = thirdApi.get_authorizer_token(authorizer_appid);
     ...
     * @return ApiResult
     */
    public static ApiResult delKfAccount(String kf_account,String authorizer_appid) {
//        String accessToken = AccessTokenApi.getAccessTokenStr();
    	String accessToken = thirdApi.get_authorizer_token(authorizer_appid);
     ...
     * @return ApiResult
     */
    public static ApiResult uploadKfAccountHeadImg(String kf_account, File headImg,String authorizer_appid) {
//        String accessToken = AccessTokenApi.getAccessTokenStr();
    	String accessToken = thirdApi.get_authorizer_token(authorizer_appid);
     ...
     * @return ApiResult
     */
    public static ApiResult getKfList(String authorizer_appid) {
//        String accessToken = AccessTokenApi.getAccessTokenStr();
    	String accessToken = thirdApi.get_authorizer_token(authorizer_appid);
     ...
     * @return ApiResult
     */
    public static ApiResult getOnlineKFList(String authorizer_appid) {
//        String accessToken = AccessTokenApi.getAccessTokenStr();
    	String accessToken = thirdApi.get_authorizer_token(authorizer_appid);
     ...
     * @return ApiResult
     */
    private static ApiResult sendMsg(Map<String, Object> message,String authorizer_appid) {
//        String accessToken = AccessTokenApi.getAccessTokenStr();
    	String accessToken = thirdApi.get_authorizer_token(authorizer_appid);
     ...
     * @return ApiResult
     */
    public static ApiResult sendText(String openId, String text,String authorizer_appid) {
        ...
        return sendMsg(json,authorizer_appid);
    }
     ...
     * @return ApiResult
     */
    public static ApiResult sendImage(String openId, String media_id,String authorizer_appid) {
        Map<String, Object> json = new HashMap<String, Object>();
        json.put("touser", openId);
     ...
     * @return ApiResult
     */
    public static ApiResult sendVoice(String openId, String media_id,String authorizer_appid) {
        Map<String, Object> json = new HashMap<String, Object>();
        json.put("touser", openId);
     ...
     * @return {ApiResult}
     */
    public static ApiResult sendVideo(String openId, String media_id, String title, String description,String authorizer_appid) {
        Map<String, Object> json = new HashMap<String, Object>();
        json.put("touser", openId);
     ...
     * @return {ApiResult}
     */
    public static ApiResult sendMusic(String openId, String musicurl, String hqmusicurl, String thumb_media_id, String title, String description,String authorizer_appid) {
        Map<String, Object> json = new HashMap<String, Object>();
        json.put("touser", openId);
     ...
     * @return {ApiResult}
     */
    public static ApiResult sendNews(String openId, List<Articles> articles,String authorizer_appid) {
        Map<String, Object> json = new HashMap<String, Object>();
        json.put("touser", openId);
     ...
     * @return ApiResult
     */
    public static ApiResult sendMpNews(String openId, String mediaId,String authorizer_appid) {
        Map<String, Object> json = new HashMap<String, Object>();
        json.put("touser", openId);
     ...
     * @return ApiResult
     */
    public static ApiResult sendCoupon(String openId, String card_id, String card_ext,String authorizer_appid) {
        Map<String, Object> json = new HashMap<String, Object>();
        json.put("touser", openId);
     ...
     * @return ApiResult
     */
    public static ApiResult inviteWorker(String kf_account, String invite_wx,String authorizer_appid) {
//        String accessToken = AccessTokenApi.getAccessTokenStr();
    	String accessToken = thirdApi.get_authorizer_token(authorizer_appid);
     ...
     * @return ApiResult
     */
    public static ApiResult createSession(String kf_account, String openid,String authorizer_appid) {
    	String accessToken = thirdApi.get_authorizer_token(authorizer_appid);
        String url = createSession + accessToken;
//        String url = createSession + AccessTokenApi.getAccessTokenStr();
     ...
     * @return ApiResult
     */
    public static ApiResult closeSession(String kf_account, String openid,String authorizer_appid) {
//    	String authorizer_access_token = memcacheApi.getAccessToken(authorizer_appid);
    	String accessToken = thirdApi.get_authorizer_token(authorizer_appid);
    	 String url = closeSession + accessToken;
//    	 String url = closeSession + AccessTokenApi.getAccessTokenStr();
     ...
     */
    public static ApiResult getSession(String openid,String authorizer_appid) {
    	String accessToken = thirdApi.get_authorizer_token(authorizer_appid);
//    	String authorizer_access_token = memcacheApi.getAccessToken(authorizer_appid);
//        String accessToken = AccessTokenApi.getAccessTokenStr();
     ...
     */
    public static ApiResult getSessionList(String kf_account,String authorizer_appid) {
//        String accessToken = AccessTokenApi.getAccessTokenStr();
//    	String accessToken = memcacheApi.getAccessToken(authorizer_appid);
    	String accessToken = thirdApi.get_authorizer_token(authorizer_appid);
     ...
     */
    public static ApiResult getWaitCase(String authorizer_appid) {
//        String accessToken = AccessTokenApi.getAccessTokenStr();
    	String accessToken = thirdApi.get_authorizer_token(authorizer_appid);
     ...
     */
    public static ApiResult getMsgList(int starttime, int endtime, int msgid, int number,String authorizer_appid) {
    	String accessToken = thirdApi.get_authorizer_token(authorizer_appid);
    	String url = getMsgList + accessToken;
