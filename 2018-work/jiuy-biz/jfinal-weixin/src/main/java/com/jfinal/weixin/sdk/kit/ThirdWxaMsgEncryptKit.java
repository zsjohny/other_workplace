 ...
 */
public class ThirdWxaMsgEncryptKit {
    ...
    public static String encrypt(String msg, String timestamp, String nonce) {
        try {
        	ThirdWxaConfig wac = ThirdWxaConfigKit.getThirdWxaConfig();
            WXBizMsgCrypt pc = new WXBizMsgCrypt(wac.getToken(), wac.getEncodingAesKey(), wac.getAppId());
    ...
    public static String decrypt(String encryptedMsg, String timestamp, String nonce, String msgSignature) {
        try {
            ...
            String encodingAesKey = wac.getEncodingAesKey();
            if (encodingAesKey == null)
                throw new IllegalStateException("encodingAesKey can not be null, config encodingAesKey first.");

            WXBizMsgCrypt pc = new WXBizMsgCrypt(wac.getToken(), encodingAesKey, wac.getAppId());
