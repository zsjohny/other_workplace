...
public class WeixinMsgController extends MsgControllerAdapter {
    ...
    protected void processInTextMsg(InTextMsg inTextMsg) {
    	//转发门店接口系统处理
    	MsgService.processInTextMsg(inTextMsg);
    ...
    protected void processInVoiceMsg(InVoiceMsg inVoiceMsg) {
    	...
    	//转发门店接口系统处理
    	MsgService.processInVoiceMsg(inVoiceMsg);
    ...
    protected void processInVideoMsg(InVideoMsg inVideoMsg) {
    	...
    	//转发门店接口系统处理
    	MsgService.processInVideoMsg(inVideoMsg);
    ...
    protected void processInShortVideoMsg(InShortVideoMsg inShortVideoMsg) {
    	//转发门店接口系统处理
    	MsgService.processInShortVideoMsg(inShortVideoMsg);
    ...
    protected void processInLocationMsg(InLocationMsg inLocationMsg) {
    	logger.info("玖远暂不需要支持该消息类型，inShortVideoMsg："+inLocationMsg.toString());
        //转发给多客服PC客户端
    ...
    protected void processInLinkMsg(InLinkMsg inLinkMsg){
    	//转发门店接口系统处理
    	MsgService.processInLinkMsg(inLinkMsg);
    ...
    {
    	//转发门店接口系统处理
    	MsgService.processInImageMsg(inImageMsg);
    ...
    protected void processInFollowEvent(InFollowEvent inFollowEvent)
    {
        if (InFollowEvent.EVENT_INFOLLOW_SUBSCRIBE.equals(inFollowEvent.getEvent()))
        {
            ...
            outMsg.setContent("这是赵兴林测试小程序</br>\r\n感谢您的关注");
            render(outMsg);
        }
