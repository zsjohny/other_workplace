 ...
 *
 */
public class ThirdWxaQrcodeApi {
     ...
     * @return ApiResult
     */
    public ApiResult createQrcode(String appId,String path) {
     ...
     * @return ApiResult
     */
    public ApiResult createQrcode(String appId,String path, int width) {
    	String authorizer_token = thirdApi.get_authorizer_token(appId);
        String url = createWxaQrcodeURL + authorizer_token;//WxaAccessTokenApi.getAccessTokenStr();
