...
public class MemcachedUtil {
    ...
    //private static final com.xiaoleilu.hutool.log.Log logger = LogFactory.get(MemcachedUtil.class);
...
//}
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        MemcachedUtil.put("mendian_web_property_value3054","30");
        Object ojb = MemcachedUtil.get("mendian_web_property_value3054");
       // System.out.printf();
        System.out.printf((String) cachedClient.get(("mendian_web_property_value3054")));
    ...
    static {
       ...
       // System.out.printf("前期："+Constants.MEMCACHED_SERVERS);
        //String[] servers = {"47.96.153.80:11212"};
        //String[] servers = {Constants.MEMCACHED_SERVERS};
        System.out.println("前期2："+servers[0]);
        Integer[] weights = { 1 };
