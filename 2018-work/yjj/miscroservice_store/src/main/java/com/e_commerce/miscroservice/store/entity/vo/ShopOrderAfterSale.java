...
public class ShopOrderAfterSale {
   ...
   // @Column(value = "after_sale_id",length = 256,commit = "售后订单号")
    ...
    private String msg;
 //@Column(value = "store_id",length = 256,commit = "商家Id")
    private Long storeId;
 //@Column(value = "member_id",length = 256,commit = "会员Id")
    private Long memberId;
    //@Column(value = "name",length = 256,commit = "姓名")
    private String name;
   //@Column(value = "count",length = 20,commit = "退款数量")
   private Integer refundCount;
  // @Column(value = "count",length = 256,commit = "退款商品名称")
   private String refundName;
    ...
    //@Column(value = "img_first",length = 256,commit = "图片凭证")
