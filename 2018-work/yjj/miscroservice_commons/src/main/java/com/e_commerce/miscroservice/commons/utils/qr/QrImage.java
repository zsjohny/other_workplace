...
public class QrImage {
     ...
     * 二维码中间图标的文件路径
     */
    private InputStream qrIconFileStream;
    ...
    public static class Builder {
        ...
        public Builder setQrIconFileStream(InputStream qrIconFileStream) {
            this.qrIconFileStream = qrIconFileStream;
            return this;
        }

        public QrImage build() {
            return new QrImage(this.qrContent, this.qrWidth, this.qrHeight, this.qrIconFilePath, this.qrIconWidth,
                    this.topWrodHeight, this.wordSize, this.wordContent, this.fileOutputPath, this.qrIconFileStream);
        }
    }

    public QrImage(String qrContent, int qrWidth, int qrHeight, String qrIconFilePath, int qrIconWidth,
                   int topWrodHeight, int wordSize, String wordContent, String fileOutputPath, InputStream qrIconFileStream) {
        this.qrContent = qrContent;
        this.qrWidth = qrWidth;
        this.qrHeight = qrHeight;
        this.qrIconFilePath = qrIconFilePath;
