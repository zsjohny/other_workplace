package com.finace.miscroservice.commons.utils.tools.iphelper;
...
public class IPSeeker {
    ...
    private Log logger = Log.getInstance(IPSeeker.class);
    ...
    private void init(){
         ...
         b4 = new byte[4];
         b3 = new byte[3];
        URL resource = IPSeeker.class.getResource("qqwry.dat");
        if (resource == null) {
            return;
        }
        IP_FILE = resource.toString().substring(5);
