...
//	 * @param request
	...
	public static boolean isAndroid(String userAgent) {
		// String userAgent = request.getHeader("user-agent").toLowerCase();
		return userAgent == null || userAgent.indexOf("android") == -1 ? false : true;
	}
	...
	public static boolean isPc(String userAgent) {
		// String userAgent = request.getHeader("user-agent").toLowerCase();
		return checkAgentIsMobile(userAgent);
	}

	/**
	 * 判断那个设备 0-未知 1-android 2-iOS 3-微信 4-电脑
	 * 
	 * @return
	 */
	public static Integer isDevice(String userAgent) {
