...
//	 * @param email
	...
	public synchronized static String generateTradeNO(long userid, String type) {
		...
		s = type + String.valueOf(retmp) + getFullTimeStr();
		return s;
	}
	...
	public static String getFullTimeStr() {
		String s = TimeUtil.dateStr(Calendar.getInstance().getTime());
		return s;
	}
...
//	 * @param String
	 ...
	 * @return
	 */
	public static String getUrlParamsStrByMap(Map<String, String> map) {
		if (map == null) {
			return "";
		}
		StringBuffer sb = new StringBuffer();
