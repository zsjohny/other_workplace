...
public class OpenAccountServiceImpl implements OpenAccountService{
    ...
    @Value("${user.account.coinstName}")
    protected String coinstName;
    @Value("${user.account.retUrl}")
    protected String retUrl;
    @Value("${user.account.successfulUrl}")
    protected String successfulUrl;
    @Value("${user.account.notifyUrl}")
    protected String notifyUrl;
    @Value("${creditgo.url}")
    protected String url;
    @Value("${creditgo.online.url}")
    protected String onlineUrl;
    @Value("${creditgo.payment.max.amount}")
    protected String maxAmount;
    @Value("${creditgo.payment.deadline}")
    protected String deadline;
    @Value("${user.withdraw.proportion}")
    protected String proportion;//提现手续费 百分比
    @Value("${user.withdraw.service.charge}")
    protected String serviceCharge; //提现手续费
    @Value("${user.withdraw.daily.time}")
