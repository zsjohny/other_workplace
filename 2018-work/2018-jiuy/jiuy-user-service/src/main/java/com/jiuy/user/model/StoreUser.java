 ...
 * @author Aison
 * @version V1.0  
 * @date 2018年06月08日 下午 06:18:25
 */
@Data
@ModelName(name = "门店商家")
public class StoreUser extends Model {  
	 ...
	 * 是否开通小程序：0未开通，1已开通
	 */  
	@FieldName(name = "是否开通小程序：0未开通，1已开通")  
	 ...
	 * 小程序类型：0个人、1企业小程序
	 */  
	@FieldName(name = "小程序类型：0个人、1企业小程序")  
	 ...
	 * 同步上新按钮状态 0：关闭  1：开启
	 */  
	@FieldName(name = "同步上新按钮状态 0：关闭  1：开启")  
	 ...
	 */  
	@FieldName(name = "小程序首页是否小时文章模块：0不显示、1显示")  
	 ...
	 * 小程序预约试穿开关：0：关闭；1：开启
	 */  
	@FieldName(name = "小程序预约试穿开关：0：关闭；1：开启")  
	private Integer shopReservationsOrderSwitch;  
 
	/**
	 * 线上小程序版本：例子：1.1.1
	 */  
	@FieldName(name = "线上小程序版本：例子：1.1.1")  
	private String onlineWxaVersion;  
 
	/**
	 * 是否开启客服热线 0：关闭 1：开启
	 */  
	@FieldName(name = "是否开启客服热线 0：关闭 1：开启")  
	...
	/**
	 * 0：审核中 1：已认证  2 : 未认证  -1:已拒绝 -2:禁用
	 */  
	@FieldName(name = "0：审核中 1：已认证  2 ")  
