...
import com.com.shark.test.feifei.dao.StudentQuery;
...
import com.shark.test.feifei.entity.Teacher;
...
public class SelectTest extends BaseQueryTest {
	...
	public void testSelectColumns(){
		query= StudentQuery.create().selectColumns(columnsConditionStudent);
		query.query();
	}
	...
	public void TestPageScrollPrevious(){
		Query<Student> queryPage= EntityQuery.<Student>create().addOption(QueryOptions.QUERY_PAGE_SCROLL).select(Student.create());
