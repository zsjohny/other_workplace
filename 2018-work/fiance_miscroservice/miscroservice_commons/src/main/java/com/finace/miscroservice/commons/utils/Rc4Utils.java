...
public class Rc4Utils {
    ...
    private static Log log = Log.getInstance(Rc4Utils.class);
    ...
    public static String toString(String data, String key) {
        ...
        try {
            ...
            //兼容之前的--TODO:一个月自动删除
            if (res.startsWith("a") || res.startsWith("i") || res.startsWith("h")) {
                result = res;
                if (res.contains(DATA_REPLACE_NUM)) {
