...
public class MobileMessageCheck {
    ...
    private static final String APP_KEY="1270608b457c1bae23495e021b02c2cb";//账号
    private static final String APP_SECRET="59bdd272e190";//密钥
    private static final String NONCE="3452344514245620L";//随机数
