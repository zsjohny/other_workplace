...
public class MobileMessageSend {
    ...
    private static final String APP_KEY="1270608b457c1bae23495e021b02c2cb";//网易云信分配的账号
    private static final String APP_SECRET="59bdd272e190";//网易云信分配的密钥
    private static final String NONCE="21342534456747L";//随机数
