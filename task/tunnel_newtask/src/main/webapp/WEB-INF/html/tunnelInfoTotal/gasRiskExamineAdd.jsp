...
<form class="definewidth m20">
    <table class="table table-bordered table-hover definewidth m10">
        ...
        <tr>
            ...
            <td>
                <input type="radio" name="riskSourceExists" value="true" checked/>存在
                <input type="radio" name="riskSourceExists" value="false"/> 不存在
            </td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text" name="seamThickness" <%--placeholder="请填写数字!!"--%>/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" name="hydrogeologicalCondition"/></td>
        </tr>
        <tr>
            <td width="10%" class="tableleft">绝对瓦斯涌出量</td>
            <td><input type="text" name="soluteGasEmissionRate" <%--placeholder="请填写数字!!"--%>/></td>
        </tr>
        <tr>
            <td width="10%" class="tableleft">瓦斯压力</td>
            <td><input type="text" name="gasPressure" <%--placeholder="请填写数字!!"--%>/></td>
        </tr>
        <tr>
            <td width="10%" class="tableleft">煤体结构类型</td>
            <td><input type="text" name="coalStructureType"/></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <button type="button" class="btn btn-primary" type="button" id="gasRiskExamineAddSave">保存</button>
                &nbsp;&nbsp;
                <button type="button" class="btn btn-success" name="backid" id="gasRiskExamineAddBackid">返回列表</button>
            </td>
        </tr>
    </table>
</form>
...
<script>
    $(function () {
        ...
        $('#gasRiskExamineAddSave').click(function () {
        ...
        $("#gasRiskExamineAddBackid").click(function () {
            var params = $("#params").val();
            //判断是否是页面选择进来的还是从原始页面进来的
            if (params.split(":")[2] == '1') {

                location.href = '/tunnel/tunnelInfoTotal/findTunnelInfoTotal.do?pageName=false&className=gasRiskExamine&tunnelNumber=' + params.split(":")[1].trim() + '&params=' + params.split(":")[0].trim() + ":" + params.split(":")[1].trim() + ':1'
                return;
            }
