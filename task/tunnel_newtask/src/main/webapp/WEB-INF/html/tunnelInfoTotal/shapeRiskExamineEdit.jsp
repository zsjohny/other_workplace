...
<form class="definewidth m20">
    <table class="table table-bordered table-hover definewidth m10">
        ...
        <tr>
            ...
            <td>
                <button type="button" class="btn btn-primary" type="button" id="shapeRiskExamineEditSave">保存</button>
                &nbsp;&nbsp;
                <button type="button" class="btn btn-success" name="backid" id="shapeRiskExamineEditBackid">返回列表
                </button>
            </td>
        </tr>
    </table>
    ...
    $(function () {
        ...
        $('#shapeRiskExamineEditSave').click(function () {
            ...
            $.post("/tunnel/tunnelInfoTotal/modifyTunnelInfoTotal.do", "className=shapeRiskExamine&id=" + id + "&tunnelNumber=" + tunnelNumber + "&riskSourceExists=" + riskSourceExists
                ...
                if (data == true) {
                    $("#shapeRiskExamineEditBackid").click();
                } else {
        ...
        $("#shapeRiskExamineEditBackid").click(function () {
            ...
            var page = $("#page").val();
            location.href = " /tunnel/tunnelInfoTotal/findTunnelInfoTotal.do?className=shapeRiskExamine&tunnelNumber=" + params.split(":")[1] + "&page=" + page +"&pageName="+$("#pageName").val().trim()+ "&params=" + params;
