...
<form class="definewidth m20">
    <table class="table table-bordered table-hover definewidth m10">
        ...
        <tr>
            ...
            <td>
                <button type="button" class="btn btn-primary" type="button" id="fireRiskExmaineEditSave">保存</button>
                &nbsp;&nbsp;
