...
public interface OuLiaoDao {
    ...
    Page<User> queryUserIsContractByAll(Integer startCount, Integer pageSize, String order);
    ...
    List<User> queryUserContractByUserNickNameOrUserAuthAndUserId(Integer startCount, Integer pageSize,
