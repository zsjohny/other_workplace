...
public class FileTools {
	public static final String WIN_FILEPATH = "E:/User/";
	public static final String LINUX_FILEPATH = "/stock/uploadFile";
	...
	public static String saveFile(MultipartFile multipartFile, String fileName) throws IllegalStateException,
		...
		String newName = fileName.substring(0, index) + new SimpleDateFormat("yyyyMMddHHmmss").format(new Date());
		newName = MD5Util.getMD5Format(newName) + extensions;
