 ...
 */
@Sharable
public abstract class QuotaHandler extends SimpleChannelInboundHandler<AbstractXtraderQuota> {
    /**
     * 日志文件
     */
    private Logger logger = LoggerFactory.getLogger(QuotaHandler.class);
    protected QuotaClient client;


    void bindClient(QuotaClient client) {
...
//            logger.info(quota.quota.replaceAll("[\r|\n]", ""));
