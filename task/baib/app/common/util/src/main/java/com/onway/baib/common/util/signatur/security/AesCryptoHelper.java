 ...
 * 
 * @author guangdong.li
 * @version $Id: AesCryptoHelper.java, v 0.1 17 Feb 2016 16:51:39 guangdong.li Exp $
 */
public class AesCryptoHelper {

    // 加密种子
    public static final String SEED = "onway888888";
    ...
    public static String decryptBase64(String seed, String encrypted) throws Exception {
        ...
        byte[] decrypted = null;
        try {
            decrypted = cipher.doFinal(BASE64.decryptBASE64(encrypted));
        } catch (Exception e) {
            // TODO: handle exception
            throw new BaseRuntimeException("来源不合法,解密出错");
        }
    ...
    public static void main(String[] args) {
        try {
            ...
            /* String originalText4 = AesCryptoHelper.decrypt(AesCryptoHelper.SEED,
                 "B75C72F44B141A0D85E5FA51802905845ABC71445E71D92EAD99ABB6D9F4F8F3");*/

            System.out.println(encryptBase64(SEED, "12345678"));
