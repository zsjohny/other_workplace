package com.onway.car.biz.service.inner.convert;
...
/**
 * 重载Spring框架Jackson convert对象，对空对象和属性做特殊处理
 *  
 * <pre>吭，MappingJacksonHttpMessageConverter这里的objectMapper私有化导致不能重载使用私有方法.
 *      使用alibaba - Jsonfast框架覆盖原生Jackson框架
 * </pre>
 * @author guangdong.li
 * @version $Id: JsonObjectHttpMessageConverter.java, v 0.1 2013-9-18 上午11:11:14 WJL Exp $
...
public class JsonObjectHttpMessageConverter extends AbstractHttpMessageConverter<Object>
    ...
    public JsonObjectHttpMessageConverter() {
        super(new MediaType("application", "json", DEFAULT_CHARSET), new MediaType("application",
    ...
    private void configurePrettyPrint() {
        if (this.prettyPrint != null) {
            this.objectMapper
                .configure(SerializationConfig.Feature.INDENT_OUTPUT, this.prettyPrint);
        }
    }
    ...
    protected void writeInternal(Object object, HttpOutputMessage outputMessage)
        ...
        try {
            ...
            this.objectMapper.writeValue(jsonGenerator, JSONObject.toJSONString(object));
    ...
    protected JavaType getJavaType(Type type, Class<?> contextClass) {
        return (contextClass != null) ? TypeFactory.type(type, TypeFactory.type(contextClass))
