...
<form class="definewidth m20">
    <table class="table table-bordered table-hover definewidth m10">
        ...
        <tr>
            ...
            <td><input type="text" name="specialRock"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <button type="button" class="btn btn-primary" type="button" id="shapeRiskExamineAddSave">保存</button>
                &nbsp;&nbsp;
                <button type="button" class="btn btn-success" name="backid" id="shapeRiskExamineAddBackid">返回列表</button>
            </td>
        </tr>
    </table>
</form>
...
<script>
    $(function () {
        ...
        $('#shapeRiskExamineAddSave').click(function () {
            ...
            $.post("/tunnel/tunnelInfoTotal/modifyTunnelInfoTotal.do", "className=shapeRiskExamine&tunnelNumber=" + tunnelNumber + "&riskSourceExists=" + riskSourceExists
                ...
                if (data == true) {
                    $("#shapeRiskExamineAddBackid").click();
                } else {
        ...
        $("#shapeRiskExamineAddBackid").click(function () {
            var params = $("#params").val(); 
     //判断是否是页面选择进来的还是从原始页面进来的
            if (params.split(":")[2] == '1') {

                location.href = '/tunnel/tunnelInfoTotal/findTunnelInfoTotal.do?pageName=false&className=shapeRiskExamine&tunnelNumber=' + params.split(":")[1].trim() + '&params=' + params.split(":")[0].trim() + ":" + params.split(":")[1].trim() + ':1'
                return;
            }
