...
<form class="definewidth m20">
    <table class="table table-bordered table-hover definewidth m10">
        ...
        <tr>
            ...
            <td>
                <button type="button" class="btn btn-primary" type="button" id="surgeMudRiskExamineAddSave">保存</button>
                &nbsp;&nbsp;
                <button type="button" class="btn btn-success" name="backid" id="surgeMudRiskExamineAddBackid">返回列表
                </button>
            </td>
        </tr>
    </table>
...
<script>
    $(function () {
        ...
        $('#surgeMudRiskExamineAddSave').click(function () {
            ...
            var shallowWater = $("input[name='topographicFeatures']").val();
            ...
            $.post("/tunnel/tunnelInfoTotal/modifyTunnelInfoTotal.do", "className=surgeMudRiskExamine&tunnelNumber=" + tunnelNumber + "&riskSourceExists=" + riskSourceExists
                ...
                if (data == true) {
                    $("#surgeMudRiskExamineAddBackid").click();
                } else {
        ...
        $("#surgeMudRiskExamineAddBackid").click(function () {
            var params = $("#params").val(); 
     //判断是否是页面选择进来的还是从原始页面进来的
            if (params.split(":")[2] == '1') {

                location.href = '/tunnel/tunnelInfoTotal/findTunnelInfoTotal.do?pageName=false&className=surgeMudRiskExamine&tunnelNumber=' + params.split(":")[1].trim() + '&params=' + params.split(":")[0].trim() + ":" + params.split(":")[1].trim() + ':1'
                return;
            }
