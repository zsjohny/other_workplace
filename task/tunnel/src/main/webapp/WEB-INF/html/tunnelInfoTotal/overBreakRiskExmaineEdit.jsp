...
<form class="definewidth m20">
    <table class="table table-bordered table-hover definewidth m10">
        ...
        <tr>
            ...
            <td><input type="text" name="undergroundWaterDevelop" value="${baseDomain.undergroundWaterDevelop}"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <button type="button" class="btn btn-primary" type="button" id="overBreakRiskExmaineEditSave">保存
                </button>
                &nbsp;&nbsp;
                <button type="button" class="btn btn-success" name="backid" id="overBreakRiskExmaineEditBackid">返回列表
                </button>
            </td>
        </tr>
    </table>
    ...
    $(function () {
        ...
        $('#overBreakRiskExmaineEditSave').click(function () {
            ...
            $.post("/tunnel/tunnelInfoTotal/modifyTunnelInfoTotal.do", "className=overBreakRiskExmaine&id=" + id + "&tunnelNumber=" + tunnelNumber + "&riskSourceExists=" + riskSourceExists
                ...
                if (data == true) {
                    $("#overBreakRiskExmaineEditBackid").click();
                } else {
        ...
        $("#overBreakRiskExmaineEditBackid").click(function () {
            ...
            var page = $("#page").val();
            location.href = " /tunnel/tunnelInfoTotal/findTunnelInfoTotal.do?className=overBreakRiskExmaine&tunnelNumber=" + params.split(":")[1] + "&page=" + page +"&pageName="+$("#pageName").val().trim()+ "&params=" + params;
