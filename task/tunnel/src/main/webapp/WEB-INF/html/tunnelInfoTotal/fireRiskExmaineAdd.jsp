    ...
    $(function () {
        ...
        $('#fireRiskExmaineAddSave').click(function () {
            ...
            $.post("/tunnel/tunnelInfoTotal/modifyTunnelInfoTotal.do", "className=fireRiskExmaine&tunnelNumber=" + tunnelNumber + "&riskSourceExists=" + riskSourceExists
                    ...
                    + "&acccessTunnel=" + acccessTunnel + "&trafficRadio=" + trafficRadio + "&truckScaleRadio=" + truckScaleRadio + "&operationalVentilationScheme=" + operationalVentilationScheme + "&fileRecue=" + fileRecue + "&monitorPlan=" + monitorPlan + "&lightPlan=" + lightPlan, function (data) {
