...
class TunnelInfo implements BaseDomain {
    ...
    // 洞门型式- 右线 - 进口端
    Double portalType_rightWire_importPort

    //  洞门型式 - 右线 - 出口端
    Double portalType_rightWire_exportPort

    //   洞门型式 - 左线 - 进口端
    Double portalType_leftWire_importPort

    //   洞门型式- 左线 - 出口端
    Double portalType_leftWire_exportPort
    ...
    @Column(length = 12)
    Double getPortalType_rightWire_importPort() {
        return portalType_rightWire_importPort
    }
    @Column(length = 12)
    Double getPortalType_rightWire_exportPort() {
        return portalType_rightWire_exportPort
    }
    @Column(length = 12)
    Double getPortalType_leftWire_importPort() {
        return portalType_leftWire_importPort
    }
    @Column(length = 12)
    Double getPortalType_leftWire_exportPort() {
        return portalType_leftWire_exportPort
    }
