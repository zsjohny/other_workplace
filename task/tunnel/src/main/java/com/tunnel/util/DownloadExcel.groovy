...
class DownloadExcel {
    ...
    static {
        ...
        properties.load(new InputStreamReader(DownloadExcel.class.getClassLoader().getResourceAsStream("englishToChinese.properties"), "gbk"));
        ...
        //加载对应的类英文名解释中文名
        properties.clear()
        properties.load(new InputStreamReader(DownloadExcel.class.getClassLoader().getResourceAsStream("classNameToChinese.properties"), "gbk"))
        ...
        //加载对应的中文解释英文excel
        properties.clear()
        properties.load(new InputStreamReader(DownloadExcel.class.getClassLoader().getResourceAsStream("chineseToEnglish.properties"), "gbk"))
        ...
        properties.clear()
        properties.load(new InputStreamReader(DownloadExcel.class.getClassLoader().getResourceAsStream("chineseToClassName.properties"), "gbk"))
        ...
        properties.clear()
        properties.load(new InputStreamReader(DownloadExcel.class.getClassLoader().getResourceAsStream("englishToClassType.properties"), "gbk"))
