...
//  PskgCommercialCity
//
//  Created by panshanGROUP on 16/12/23.
//  Copyright © 2016年 PANSHANHOLDINGGROUP. All rights reserved.
//
...
+(NSDictionary*)encryptWithDESAndRSA:(NSData*) data withKey:(NSString*)key keyPath:(NSString*)keyPath{
    ...
    //rsa
    NSString* encryptedKey = [dyc RSAEncryptData:key keyPath:keyPath];
    
    //des
    NSData* encryptedData = [dyc DESEncrypt:data WithKey:key];
...
+(NSString*)RSAEncryptData:(NSString*)text keyPath:(NSString*)keyPath{
    NSData* data = [dyc RSAEncryptToData:text keyPath:keyPath];
...
+(NSString*)DESEncryptWithBase64:(NSString*)str key:(NSString*)key{
    ...
    NSData* encryptData = [dyc DESEncrypt:data WithKey:key];
...
+(NSString*)DESDecryptBase64:(NSString*)base64 key:(NSString*)key{
    ...
    NSData* data = [dyc DESDecrypt:encryptData WithKey:key];
