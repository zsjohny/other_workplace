...
#import "UserInfoXpManager.h"
#import "GetUUID.h"
//自己设定
#define HOST @"52woo.com"
#define PORT 8073
...
- (void)startConnectSocket
{
    ...
    NSMutableString *socketstringM = [NSMutableString string];
    [socketstringM  appendString: [UserInfoXpManager getToken]];
    [socketstringM  appendString:@":"];
    [socketstringM  appendString:[GetUUID getUUID]];
    [socketstringM  appendString:@":"];
    [socketstringM  appendString:@"notify"];
    NSLog(@"%@",socketstringM);
    //发送消息
    [socketServe sendMessage:socketstringM];
...
-(void)checkLongConnectByServe{
    ...
    NSString *longConnect = socketstringM;
...
- (void)onSocket:(AsyncSocket *)sock didReadData:(NSData *)data withTag:(long)tag
{
    ...
    if( data.length < MAX_BUFFER )
    {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"changlianjie" object:@"lianjie"userInfo:dic];
