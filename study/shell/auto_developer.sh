...
miscroservice_arr="miscroservice_register_discovery_centers_v1 miscroservice_register_discovery_centers_v2 miscroservice_config   miscroservice_authorize   miscroservice_task_scheduling  miscroservice_official_website miscroservice_user  miscroservice_borrow  miscroservice_activity miscroservice_getway"
...
echo  $service
	...
	if [[ $service == "miscroservice_getway" ]];then 
	  ...
	  `mv ./miscroservice_getway/Dockerfile ./miscroservice_getway/build/libs &&docker stop java&&docker rm java&&docker build -t java ./miscroservice_getway/build/libs&&docker run -dit --name java -v /tmp:/tmp -p 1020:1020 -p 8081:8081 java`
	  echo 'success'
