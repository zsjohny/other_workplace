...
public class DoubleWayTlsPool {
    ...
    public static final String KEY_STORE_TRUST_PATH = "C:\\Users\\nessary\\Desktop\\server.jks"; // truststore的路径
    ...
    public static final String KEY_STORE_CLIENT_PATH="C:\\Users\\nessary\\Desktop\\client.p12";
    ...
    static {
        ...
        // 个性化设置某个url的连接
        connManager.setMaxPerRoute(new HttpRoute(new HttpHost("test.etongjin.net", 80)), 20);
    ...
    public static void doubleWayAuthorizationAccepted() throws ClientProtocolException, IOException {
        ...
        HttpGet httpget = new HttpGet("https://test.etongjin.net/log");
        // 设置请求的配置
